...
{  
    ...
    {     
        ...
        Font bigFont1 = textField1.getFont().deriveFont(Font.PLAIN, 25f);
        textField1.setFont(bigFont1);
        JLabel passLabel = new JLabel("                        Password");    
        passLabel.setFont(new Font("Arial", Font.PLAIN, 30));    
        textField2 = new JPasswordField(8);  
        Font bigFont2 = textField2.getFont().deriveFont(Font.PLAIN, 25f); 
        textField2.setFont(bigFont2);
        b1 = new JButton("SUBMIT");  
        b1.setFont(new Font("Arial", Font.PLAIN, 20)); 
        newPanel = new JPanel(new GridLayout(2,2,70,300));  
